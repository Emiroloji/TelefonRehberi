...
namespace Rehber19 {
    ...
    public partial class TelefonRehberiDataSet : global::System.Data.DataSet {
        ...
        public partial class PersonDataTable : global::System.Data.TypedTableBase<PersonRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public PersonRow AddPersonRow(string Name, string Surname, string Phone, string EMail, string Address) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public PersonRow FindByıd(int ıd) {
        ...
        public partial class PersonRow : global::System.Data.DataRow {
            ...
            public int ıd {
                get {
                    return ((int)(this[this.tablePerson.ıdColumn]));
                }
                set {
                    this[this.tablePerson.ıdColumn] = value;
                }
            }
...
namespace Rehber19.TelefonRehberiDataSetTableAdapters {
    ...
    public partial class PersonTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Person] WHERE (([ıd] = @Original_ıd) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Surname = 1 AND [Surname] IS NULL) OR ([Surname] = @Original_Surname)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)) AND ((@IsNull_EMail = 1 AND [EMail] IS NULL) OR ([EMail] = @Original_EMail)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Person] ([Name], [Surname], [Phone], [EMail], [Address]) VALUE" +
                "S (@Name, @Surname, @Phone, @EMail, @Address);\r\nSELECT ıd, Name, Surname, Phone," +
                " EMail, Address FROM Person WHERE (ıd = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Person] SET [Name] = @Name, [Surname] = @Surname, [Phone] = @Phone, [EMail] = @EMail, [Address] = @Address WHERE (([ıd] = @Original_ıd) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Surname = 1 AND [Surname] IS NULL) OR ([Surname] = @Original_Surname)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)) AND ((@IsNull_EMail = 1 AND [EMail] IS NULL) OR ([EMail] = @Original_EMail)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)));
SELECT ıd, Name, Surname, Phone, EMail, Address FROM Person WHERE (ıd = @ıd)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Rehber19.Properties.Settings.Default.TelefonRehberiConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ıd, Name, Surname, Phone, EMail, Address FROM dbo.Person";
        ...
        public virtual int Fill(TelefonRehberiDataSet.PersonDataTable dataTable) {
        ...
        public virtual TelefonRehberiDataSet.PersonDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            TelefonRehberiDataSet.PersonDataTable dataTable = new TelefonRehberiDataSet.PersonDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(TelefonRehberiDataSet.PersonDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ıd, string Original_Name, string Original_Surname, string Original_Phone, string Original_EMail, string Original_Address) {
        ...
        public virtual int Insert(string Name, string Surname, string Phone, string EMail, string Address) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string Surname, string Phone, string EMail, string Address, int Original_ıd, string Original_Name, string Original_Surname, string Original_Phone, string Original_EMail, string Original_Address, int ıd) {
            if ((Name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Surname, string Phone, string EMail, string Address, int Original_ıd, string Original_Name, string Original_Surname, string Original_Phone, string Original_EMail, string Original_Address) {
            return this.Update(Name, Surname, Phone, EMail, Address, Original_ıd, Original_Name, Original_Surname, Original_Phone, Original_EMail, Original_Address, Original_ıd);
        }
    }
